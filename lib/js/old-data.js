...
dataSource.products = {
  ...
  pizza: {
    ...
    images: ['<img class="active" src="images/pizza/crust.svg">', '<img class="sauce-tomato" src="images/pizza/tomato-sauce.svg">', '<img class="sauce-cream" src="images/pizza/sour-cream.svg">', '<img class="toppings-salami" src="images/pizza/salami.svg">', '<img class="toppings-olives" src="images/pizza/olives.svg">', '<img class="toppings-redPeppers" src="images/pizza/red-peppers.svg">', '<img class="toppings-greenPeppers" src="images/pizza/green-peppers.svg">', '<img class="toppings-mushrooms" src="images/pizza/mushrooms.svg">', '<img class="toppings-basil" src="images/pizza/basil.svg">'],
    params: {
      sauce: {
        label: 'Sauce',
        type: 'radios',
  ...
  salad: {
    ...
    images: ['<img class="active" src="images/salad/plate.svg">', '<img class="ingredients-cucumber" src="images/salad/cucumber.svg" style="z-index: 1;">', '<img class="ingredients-tomatoes" src="images/salad/tomatoes.svg" style="z-index: 2;">', '<img class="ingredients-olives" src="images/salad/salad-olives.svg" style="z-index: 3;">', '<img class="ingredients-feta" src="images/salad/feta.svg" style="z-index: 4;">', '<img class="ingredients-herbs" src="images/salad/herbs.svg" style="z-index: 5;">', '<img class="ingredients-cheese" src="images/salad/cheese.svg" style="z-index: 6;">', '<img class="ingredients-pepper" src="images/salad/black-pepper.svg" style="z-index: 7;">'],
    params: {
      ingredients: {
        label: 'Ingredients',
        type: 'checkboxes',
